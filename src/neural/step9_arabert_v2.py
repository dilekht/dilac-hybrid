"""
Step 9 AraBERT v2 — GlossBERT (AraBERT) with Enriched Glosses
=================================================
...
if not _c: raise FileNotFoundError('gold_test_v2.json not found')
...
# ── Run ───────────────────────────────────────────────────────────────────────
MODELS=[('aubmindlab/bert-base-arabertv2','AraBERT-v2')]
all_results=[]
